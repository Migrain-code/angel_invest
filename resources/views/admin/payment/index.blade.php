...
@section('breadcrumb')
    <!--begin::Title-->
    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Ödemeler</h1>
    <!--end::Title-->
    <!--begin::Breadcrumb-->
...
@section('content')
    <div id="kt_app_content_container" class="app-container container-xxl">
        ...
        <div class="card">
            <!--begin::Card header-->
            @include('admin.payment.components.toolbar')
            <!--end::Card header-->
            <!--begin::Card body-->
            <div class="card-body pt-0">
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="datatable">
                    ...
                    <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                        ...
                        <th class="max-w-80px">Ödenecek</th>
...
@section('scripts')
    <script>
        let DATA_URL = "{{route('admin.payment.datatable')}}";
        let DATA_COLUMNS = [
            {data: 'id'},
            {data: 'user_id'},
            {data: 'currency'},
