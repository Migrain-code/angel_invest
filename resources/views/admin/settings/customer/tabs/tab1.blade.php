    ...
    <form enctype="multipart/form-data" class="form" action="{{route('admin.settings.update')}}" method="post">
        ...
        <div class="modal-body py-5 px-lg-17">
            <!--begin::Scroll-->
                ...
                <div class="fv-row mb-7">
                    <!--begin::Label-->
                    <label class="required fs-6 fw-semibold mb-2">OG Image Icon (50 * 50)</label>
                    <!--end::Label-->
                    <!--begin::Input-->
                    <input type="file" class="form-control form-control-solid" placeholder="" name="og_image" value="" />
                    <!--end::Input-->
                    <div class="imgBox bg-dark">
                        <img src="{{image(setting('og_image'))}}" class="p-3" style="width: 50px; height: 50px">
                    </div>
                </div>
                <div class="fv-row mb-7">
                    <!--begin::Label-->
