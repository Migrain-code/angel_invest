<div class="roadmap pb120 _relative d-block d-lg-none mt-5">
    <div class="container">
        <div class="row">
            <div class="col-lg-7 m-auto text-center">
                <div class="heading2">
                        <span class="span" data-aos="zoom-in-left" data-aos-duration="700">
                           <span>{{__('ANGELX Roadmap')}}</span>
                        </span>
                    ...
                    <div class="row align-items-center parent-area  @if($loop->index == 0) active @endif">
                        <div class="col-lg-6">
                            <div class="circle-box-area">
                                ...
                                <img src="/frontend/assets/img/shapes/roadmap-shape.png" alt="ANGELX" class="line-shape">
                            </div>
                        </div>
